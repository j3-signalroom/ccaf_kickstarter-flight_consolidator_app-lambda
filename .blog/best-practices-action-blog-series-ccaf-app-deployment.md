...
To keep it simple, I created just one module that contains the import statements, Constants, and AWS Lambda handler function. 
...
##### 2.1.2.2 Constants
I am a big fan of constants, as they make your code more readable and maintainable. Here are the constants you’ll need to define at the top of your Python script:
```python
...
- `event` (Dict): A dictionary containing data passed to the function. This data is typically generated by an AWS service, such as an S3 bucket or an API Gateway.  In this case, the event is the data passed to the Lambda function by the AWS Lambda service in the form of a JSON object in the Terraform configuration.
- `context` (LambdaContext): An object that provides information about the invocation, function, and execution environment.

The handler function returns a value, which can be a simple string, a JSON-serializable dictionary, or other data structures depending on what the event source expects.  In this case, the handler function returns a JSON object that contains the status of the deployment, `statusCode`, and `body`.

###### 2.1.2.3.1 The Lambda Handler Function Code
...
###### 2.1.2.3.2 The Lambda Handler Function Code
...
###### 2.1.2.3.3 The Lambda Handler Function Code
...
###### 2.1.2.3.4 The Lambda Handler Function Code
...
###### 2.1.2.3.5 The Lambda Handler Function Code
...
###### 2.1.2.3.6 The Lambda Handler Function Code
...
###### 2.1.2.3.7 The Lambda Handler Function Code
...
###### 2.1.2.3.8 The Lambda Handler Function Code
...
###### 2.1.2.3.9 The Lambda Handler Function Code
